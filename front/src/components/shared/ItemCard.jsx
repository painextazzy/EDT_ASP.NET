    ...
    <div className="bg-white rounded-2xl shadow-md border border-gray-100 hover:shadow-lg transition-all duration-200 group relative overflow-hidden min-h-[240px] flex flex-col">
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="flex-1">
          <h3 className="font-bold text-gray-800 text-base mb-2 group-hover:text-sky-600 transition-colors line-clamp-2">
            {item.name}
          </h3>
          {extraInfo && (
            <p className="text-[11px] text-gray-400 font-mono bg-gray-50 inline-block px-2 py-1 rounded-md">
              {extraInfo}
            </p>
          )}
        </div>
