// src/components/NiveauxList.jsx
import React, { useState } from 'react';
import ItemCard from './shared/ItemCard';
import SkeletonCard from './ui/SkeletonCard';
import { Plus } from 'lucide-react';

const NiveauxList = ({ items, onAdd, onUpdate, onDelete, loading = false }) => {
    ...
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
        ...
        >
          ...
          <span className="font-semibold text-sm uppercase tracking-wider text-center">Ajouter un niveau</span>
        </div>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4 animate-scaleIn">
            <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl">
              <div className="px-6 py-4 border-b border-gray-100">
                <h3 className="text-xl font-semibold text-gray-800">Ajouter un niveau</h3>
              </div>
              <div className="p-6">
                <input
                  type="text"
